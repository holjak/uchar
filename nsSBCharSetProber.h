...
public:
  ...
  virtual void  BitShift(unsigned char* aBuf, unsigned char* copy_aBuf, PRUint32 start, PRUint32 aLen, PRUint32 shift_bit);
  virtual void      ErrorRecover(unsigned char* aBuf, PRUint32 aLen);
  virtual PRUint32      GetScore(unsigned char shift_bit[][65536], PRUint32 start, PRUint32 aLen);
